import type {Item} from "src/components/Accordion.vue";
...
export const AccordionMock: Item[] = [
	{
		...
		content:
			"O NEI Market Analytics é um projeto de pesquisa e desenvolvimento para auxiliar diversos nichos de investimento, como criptomoedas, moedas globais e skins de jogos.",
	},
	{
		value: "item-2",
