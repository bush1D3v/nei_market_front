...
<template>
    <DialogPortal>
        ...
        <DialogContent :aria-describedby="ariaDescribedBy" v-bind="forwarded" :class="cn(
            ...
            <DialogClose
                class="absolute right-4 top-3 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-accent data-[state=open]:text-muted-foreground z-50">
